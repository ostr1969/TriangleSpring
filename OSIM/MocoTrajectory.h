...
// discourage use.
    ...
    void appendParameter(const std::string& name, const double value);
    void appendControls(std::vector<std::string> control_names,double value);
    void removeState(const std::string& name);
    void removeStates(std::vector<std::string> names);
    void removeControl(const std::string& name);
    void removeControls(std::vector<std::string> names); 
