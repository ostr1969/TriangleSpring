...
//==============================================================================
    ...
    OpenSim_DECLARE_OUTPUT(loc_y, double, getLocY,
                           SimTK::Stage::Acceleration);
    OpenSim_DECLARE_OUTPUT(loc_x, double, getLocX,
                           SimTK::Stage::Acceleration);
    OpenSim_DECLARE_OUTPUT(loc_z, double, getLocZ,
                           SimTK::Stage::Acceleration);
    OpenSim_DECLARE_OUTPUT(acc_y, double, getAccY,
                           SimTK::Stage::Acceleration);
    OpenSim_DECLARE_OUTPUT(acc_x, double, getAccX,
                           SimTK::Stage::Acceleration);
    OpenSim_DECLARE_OUTPUT(acc_z, double, getAccZ,
                           SimTK::Stage::Acceleration);
//=============================================================================
// METHODS
//=============================================================================
...
protected:
    double getLocY     ( const SimTK::State& s) const ;
    double getLocX     ( const SimTK::State& s) const ;
    double getLocZ     ( const SimTK::State& s) const ;
    double getAccY     ( const SimTK::State& s) const ;
    double getAccX     ( const SimTK::State& s) const ;
    double getAccZ     ( const SimTK::State& s) const ;
