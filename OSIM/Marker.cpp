...
double Marker::getLocY( const SimTK::State& s ) const
{
		    return getLocationInGround(s)[1];
}
double Marker::getLocX( const SimTK::State& s ) const
{
		    return getLocationInGround(s)[0];
}
double Marker::getLocZ( const SimTK::State& s ) const
{
		    return getLocationInGround(s)[3];
}
double Marker::getAccY( const SimTK::State& s ) const
{
		    return getAccelerationInGround(s)[1];
}
double Marker::getAccX( const SimTK::State& s ) const
{
		    return getAccelerationInGround(s)[0];
}
double Marker::getAccZ( const SimTK::State& s ) const
{
		    return getAccelerationInGround(s)[3];
}
